...
export type DataAndSuccessResponse_dict_str__str__ = {
    data: {
        [key: string]: (string);
    };
    success: boolean;
...
export type SetAllSettingsResponse = {
    success: boolean;
    message: string;
};
...
export type HealthResponse = (MessageAndSuccessResponse);

export type HealthError = (unknown);

export type RdResponse = (DataAndSuccessResponse_RDUser_);
...
export type TraktOauthCallbackResponse = (MessageAndSuccessResponse);
...
export type EventsResponse = (DataAndSuccessResponse_dict_str__list_EventUpdate___);

export type EventsError = (unknown);

export type MountResponse = (DataAndSuccessResponse_dict_str__str__);
...
export type LoadSettingsResponse2 = (LoadSettingsResponse);

export type LoadSettingsError = (unknown);

export type SaveSettingsResponse2 = (SaveSettingsResponse);

export type SaveSettingsError = (unknown);

export type GetAllSettingsResponse2 = (GetAllSettingsResponse);
...
export type GetSettingsResponse2 = (GetSettingsResponse);
...
export type SetAllSettingsResponse2 = (SetAllSettingsResponse);

export type SetAllSettingsError = (unknown | HTTPValidationError);

export type SetSettingsSettingsSetPostData = {
    body: Array<SetSettings>;
};

export type SetSettingsSettingsSetPostResponse = (SetSettingsResponse);

export type SetSettingsSettingsSetPostError = (unknown | HTTPValidationError);
...
export type AddItemsResponse2 = (AddItemsResponse);
...
export type GetItemsByImdbIdsResponse = (ItemsByImdbResponse);
...
export type SetTorrentRdItemsIdSetTorrentRdPostResponse = (unknown);

...
export class SettingsService {
    ...
    public static loadSettings<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<LoadSettingsResponse2, LoadSettingsError, ThrowOnError>({
            ...options,
            url: '/settings/load'
        });
    }
    ...
    public static saveSettings<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).post<SaveSettingsResponse2, SaveSettingsError, ThrowOnError>({
            ...options,
            url: '/settings/save'
        });
    }
    ...
    public static getAllSettings<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<GetAllSettingsResponse2, GetAllSettingsError, ThrowOnError>({
            ...options,
    ...
    public static getSettings<ThrowOnError extends boolean = false>(options: Options<GetSettingsData, ThrowOnError>) {
        return (options?.client ?? client).get<GetSettingsResponse2, GetSettingsError, ThrowOnError>({
            ...options,
    ...
    public static setAllSettings<ThrowOnError extends boolean = false>(options: Options<SetAllSettingsData, ThrowOnError>) {
        return (options?.client ?? client).post<SetAllSettingsResponse2, SetAllSettingsError, ThrowOnError>({
            ...options,
     ...
     * Set Settings
     */
    public static setSettingsSettingsSetPost<ThrowOnError extends boolean = false>(options: Options<SetSettingsSettingsSetPostData, ThrowOnError>) {
        return (options?.client ?? client).post<SetSettingsSettingsSetPostResponse, SetSettingsSettingsSetPostError, ThrowOnError>({
            ...options,
            url: '/settings/set'
        });
    }
...
export class ItemsService {
    ...
    public static addItems<ThrowOnError extends boolean = false>(options?: Options<AddItemsData, ThrowOnError>) {
        return (options?.client ?? client).post<AddItemsResponse2, AddItemsError, ThrowOnError>({
            ...options,
            url: '/items/add'
        });
    }
...
export class ScrapeService {
    ...
    public static scrape<ThrowOnError extends boolean = false>(options: Options<ScrapeData, ThrowOnError>) {
        return (options?.client ?? client).get<ScrapeResponse2, ScrapeError, ThrowOnError>({
            ...options,
            url: '/scrape'
        });
    }

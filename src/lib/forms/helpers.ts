...
export function generalSettingsToPass(data: any) {
	return {
		...
		movie_filesize_min: data.downloaders.movie_filesize_min,
		movie_filesize_max: data.downloaders.movie_filesize_max,
		episode_filesize_min: data.downloaders.episode_filesize_min,
		episode_filesize_max: data.downloaders.episode_filesize_max,

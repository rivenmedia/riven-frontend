...
export const generalSettingsSchema = z.object({
	...
	prefer_speed_over_quality: z.boolean().default(true),
	...
	torbox_proxy_enabled: z.boolean().default(false),
	torbox_proxy_url: z.string().optional().default(''),
...
export function generalSettingsToPass(data: any) {
	return {
		...
		torbox_proxy_enabled: data.downloaders.torbox.proxy_enabled,
		torbox_proxy_url: data.downloaders.torbox.proxy_url,
	...
	return [
		...
		},
		{
			...
			value: {
				...
				prefer_speed_over_quality: form.data.prefer_speed_over_quality,
				...
				torbox: {
					...
					proxy_enabled: form.data.torbox_proxy_enabled,
					proxy_url: form.data.torbox_proxy_url
				}
			}
		},
		{

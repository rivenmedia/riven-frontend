...
import type { RootError, RootResponse2, HealthError, HealthResponse, RdError, RdResponse, GenerateapikeyError, GenerateapikeyResponse, ServicesError, ServicesResponse, TraktOauthInitiateError, TraktOauthInitiateResponse, TraktOauthCallbackData, TraktOauthCallbackError, TraktOauthCallbackResponse, StatsError, StatsResponse2, LogsError, LogsResponse2, EventsError, EventsResponse, MountError, MountResponse2, UploadLogsError, UploadLogsResponse2, FetchCalendarError, FetchCalendarResponse, OverseerrApiV1WebhookOverseerrPostError, OverseerrApiV1WebhookOverseerrPostResponse, GetStatesError, GetStatesResponse, GetItemsData, GetItemsError, GetItemsResponse, AddItemsData, AddItemsError, AddItemsResponse, GetItemData, GetItemError, GetItemResponse, GetItemsByImdbIdsData, GetItemsByImdbIdsError, GetItemsByImdbIdsResponse, ResetItemsData, ResetItemsError, ResetItemsResponse, RetryItemsData, RetryItemsError, RetryItemsResponse, RetryLibraryItemsError, RetryLibraryItemsResponse, UpdateOngoingItemsError, UpdateOngoingItemsResponse, RepairSymlinksData, RepairSymlinksError, RepairSymlinksResponse2, RemoveItemData, RemoveItemError, RemoveItemResponse, GetItemStreamsApiV1ItemsItemIdStreamsGetData, GetItemStreamsApiV1ItemsItemIdStreamsGetError, GetItemStreamsApiV1ItemsItemIdStreamsGetResponse, BlacklistStreamApiV1ItemsItemIdStreamsStreamIdBlacklistPostData, BlacklistStreamApiV1ItemsItemIdStreamsStreamIdBlacklistPostError, BlacklistStreamApiV1ItemsItemIdStreamsStreamIdBlacklistPostResponse, UnblacklistStreamApiV1ItemsItemIdStreamsStreamIdUnblacklistPostData, UnblacklistStreamApiV1ItemsItemIdStreamsStreamIdUnblacklistPostError, UnblacklistStreamApiV1ItemsItemIdStreamsStreamIdUnblacklistPostResponse, ResetItemStreamsData, ResetItemStreamsError, ResetItemStreamsResponse, PauseItemsData, PauseItemsError, PauseItemsResponse, UnpauseItemsData, UnpauseItemsError, UnpauseItemsResponse, TraktReindexerData, TraktReindexerError, TraktReindexerResponse, FfprobeMediaFilesData, FfprobeMediaFilesError, FfprobeMediaFilesResponse, ScrapeItemData, ScrapeItemError, ScrapeItemResponse2, StartManualSessionData, StartManualSessionError, StartManualSessionResponse, ManualSelectData, ManualSelectError, ManualSelectResponse, ManualUpdateAttributesData, ManualUpdateAttributesError, ManualUpdateAttributesResponse, AbortManualSessionData, AbortManualSessionError, AbortManualSessionResponse, CompleteManualSessionData, CompleteManualSessionError, CompleteManualSessionResponse, ParseTorrentTitlesData, ParseTorrentTitlesError, ParseTorrentTitlesResponse, GetSettingsSchemaError, GetSettingsSchemaResponse, LoadSettingsError, LoadSettingsResponse, SaveSettingsError, SaveSettingsResponse, GetAllSettingsError, GetAllSettingsResponse, GetSettingsData, GetSettingsError, GetSettingsResponse, SetAllSettingsData, SetAllSettingsError, SetAllSettingsResponse, SetSettingsData, SetSettingsError, SetSettingsResponse, GetEventTypesApiV1StreamEventTypesGetError, GetEventTypesApiV1StreamEventTypesGetResponse, StreamEventsApiV1StreamEventTypeGetData, StreamEventsApiV1StreamEventTypeGetError, StreamEventsApiV1StreamEventTypeGetResponse } from './types.gen';
...
export class DefaultService {
    ...
    public static logs<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<LogsResponse2, LogsError, ThrowOnError>({
            ...options,
            url: '/api/v1/logs'
        });
    }
    ...
    public static mount<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<MountResponse2, MountError, ThrowOnError>({
            ...options,
            url: '/api/v1/mount'
        });
    }
     ...
     */
    public static fetchCalendar<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).get<FetchCalendarResponse, FetchCalendarError, ThrowOnError>({
            ...options,
            url: '/api/v1/calendar'
        });
    }
...
export class ItemsService {
     ...
     */
    public static retryLibraryItems<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).post<RetryLibraryItemsResponse, RetryLibraryItemsError, ThrowOnError>({
            ...options,
     ...
     */
    public static updateOngoingItems<ThrowOnError extends boolean = false>(options?: Options<unknown, ThrowOnError>) {
        return (options?.client ?? client).post<UpdateOngoingItemsResponse, UpdateOngoingItemsError, ThrowOnError>({
            ...options,
     ...
     */
    public static repairSymlinks<ThrowOnError extends boolean = false>(options?: Options<RepairSymlinksData, ThrowOnError>) {
        return (options?.client ?? client).post<RepairSymlinksResponse2, RepairSymlinksError, ThrowOnError>({
            ...options,
     ...
     */
    public static resetItemStreams<ThrowOnError extends boolean = false>(options: Options<ResetItemStreamsData, ThrowOnError>) {
        return (options?.client ?? client).post<ResetItemStreamsResponse, ResetItemStreamsError, ThrowOnError>({
            ...options,
     ...
     */
    public static pauseItems<ThrowOnError extends boolean = false>(options: Options<PauseItemsData, ThrowOnError>) {
        return (options?.client ?? client).post<PauseItemsResponse, PauseItemsError, ThrowOnError>({
            ...options,
     ...
     */
    public static unpauseItems<ThrowOnError extends boolean = false>(options: Options<UnpauseItemsData, ThrowOnError>) {
        return (options?.client ?? client).post<UnpauseItemsResponse, UnpauseItemsError, ThrowOnError>({
            ...options,
     ...
     */
    public static traktReindexer<ThrowOnError extends boolean = false>(options?: Options<TraktReindexerData, ThrowOnError>) {
        return (options?.client ?? client).post<TraktReindexerResponse, TraktReindexerError, ThrowOnError>({
            ...options,
     ...
     * Parse a media file
     */
    public static ffprobeMediaFiles<ThrowOnError extends boolean = false>(options: Options<FfprobeMediaFilesData, ThrowOnError>) {
        return (options?.client ?? client).post<FfprobeMediaFilesResponse, FfprobeMediaFilesError, ThrowOnError>({
            ...options,
...
export class ScrapeService {
     ...
     */
    public static startManualSession<ThrowOnError extends boolean = false>(options: Options<StartManualSessionData, ThrowOnError>) {
        return (options?.client ?? client).post<StartManualSessionResponse, StartManualSessionError, ThrowOnError>({
            ...options,
     ...
     */
    public static abortManualSession<ThrowOnError extends boolean = false>(options: Options<AbortManualSessionData, ThrowOnError>) {
        return (options?.client ?? client).post<AbortManualSessionResponse, AbortManualSessionError, ThrowOnError>({
            ...options,
     ...
     */
    public static parseTorrentTitles<ThrowOnError extends boolean = false>(options: Options<ParseTorrentTitlesData, ThrowOnError>) {
        return (options?.client ?? client).post<ParseTorrentTitlesResponse, ParseTorrentTitlesError, ThrowOnError>({
            ...options,

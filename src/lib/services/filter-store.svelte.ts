...
export const SORT_OPTIONS = [
    { value: "popularity.desc", label: "Most Popular", allowedFor: ["movie", "tv"] },
    { value: "popularity.asc", label: "Least Popular", allowedFor: ["movie", "tv"] },
    { value: "vote_average.desc", label: "Highest Rated", allowedFor: ["movie", "tv"] },
    { value: "vote_average.asc", label: "Lowest Rated", allowedFor: ["movie", "tv"] },
    { value: "primary_release_date.desc", label: "Newest", allowedFor: ["movie", "tv"] },
    { value: "primary_release_date.asc", label: "Oldest", allowedFor: ["movie", "tv"] },

 ...
 * Fetch a single media item by item ID
 */
 ...
 */
export const getItemStreams = <ThrowOnError extends boolean = false>(options: Options<GetItemStreamsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetItemStreamsResponses, GetItemStreamsErrors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zGetItemStreamsData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zGetItemStreamsResponse.parseAsync(data);
        },
        security: [
            {
                name: 'x-api-key',
 ...
 */
export const blacklistItemStream = <ThrowOnError extends boolean = false>(options: Options<BlacklistItemStreamData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<BlacklistItemStreamResponses, BlacklistItemStreamErrors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zBlacklistItemStreamData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zBlacklistItemStreamResponse.parseAsync(data);
        },
        security: [
            {
                name: 'x-api-key',
 ...
 */
export const unblacklistItemStream = <ThrowOnError extends boolean = false>(options: Options<UnblacklistItemStreamData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<UnblacklistItemStreamResponses, UnblacklistItemStreamErrors, ThrowOnError>({
        requestValidator: async (data) => {
            return await zUnblacklistItemStreamData.parseAsync(data);
        },
        responseValidator: async (data) => {
            return await zUnblacklistItemStreamResponse.parseAsync(data);
        },
        security: [
            {
                name: 'x-api-key',
...
export const resetItemStreams = <ThrowOnError extends boolean = false>(options: Options<ResetItemStreamsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<ResetItemStreamsResponses, ResetItemStreamsErrors, ThrowOnError>({
        ...
        responseValidator: async (data) => {
            return await zResetItemStreamsResponse.parseAsync(data);
        },
        security: [
            {
                name: 'x-api-key',
...
export const getEventTypesApiV1StreamEventTypesGet = <ThrowOnError extends boolean = false>(options?: Options<GetEventTypesApiV1StreamEventTypesGetData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetEventTypesApiV1StreamEventTypesGetResponses, GetEventTypesApiV1StreamEventTypesGetErrors, ThrowOnError>({
        ...
        responseValidator: async (data) => {
            return await zGetEventTypesApiV1StreamEventTypesGetResponse.parseAsync(data);
        },
        security: [
            {
                name: 'x-api-key',
